        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col gap-6">
            <div data-aos="fade-right">
              ...
              <p className="mt-4  text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-center dark:text-gray-400">
              ...
              <p className="mt-4 text-center text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
