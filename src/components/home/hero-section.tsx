	...
	return (
		<section className="relative">
			...
			<div className="absolute top-[50%] mx-auto left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 lg:w-1/2 3xl:w-[60vw] 3xl:top-[40%] backdrop-filter backdrop-blur-md bg-gray-900/30 p-3 rounded-md gap-3 sm:gap-6 flex items-center flex-col">
				<h1
					className={cn(
						"3xl:hidden block text-white text-xl md:text-3xl xl:text-5xl 2xl:font-black font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-red-400 to-orange-600 via-amber-300",
						font.className
					)}
					data-aos="fade-up"
				>
